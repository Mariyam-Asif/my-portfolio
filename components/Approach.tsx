    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="We'll work together to define the objectives, target audience, and essential features of your website. We'll cover aspects such as site layout, navigation, and content needs."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development & Ongoing Updates" 
        icon={<AceternityIcon order="Phase 2" />}
        description="Once we finalize the plan, I dive into coding and work on everything from initial drafts to refined code, I'll keep you informed throughout the entire process."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        description="This is where the real work begins! Using the approved design, I’ll turn it into functional code and build your website from the ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
